#!/usr/bin/env python3
"""
Test script to verify that the tools are working correctly with wrapper functions
"""
...
async def test_tools():
    ...
    print("🧪 Testing Enhanced HardGate Agent Tools")
    print("=" * 50)
...
""")
        ...
        try:
            ...
            repo_result = await analyze_repository(repository_path=sample_repo_path)
            ...
            print("\n🎉 All tools are working correctly with the wrapper functions!")
