...
def generate_report(analysis_data: dict, report_type: str = "comprehensive", output_format: str = "json", output_path: Optional[str] = None, tool_context = None) -> Dict[str, Any]:
    """
    Generate comprehensive security and compliance reports.
    
    Args:
        analysis_data: Data from all analysis steps
        report_type: Type of report to generate (comprehensive, executive, technical, compliance)
