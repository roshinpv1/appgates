...
class CodeGatesPDFGenerator:
    ...
    def _build_recommendations_section(self, gate: Dict[str, Any]) -> List:
        """Build recommendations section like HTML report"""
        elements = []
        ...
        # Filter recommendations like HTML report (remove "Achieved:" and coverage-related)
        ...
        elements.append(Paragraph("Recommendations", self.custom_styles['Heading1']))
        
        # Show up to 5 recommendations like HTML report
        for rec in filtered_recommendations[:5]:
            elements.append(Paragraph(f"• {rec}", self.custom_styles['Normal']))
