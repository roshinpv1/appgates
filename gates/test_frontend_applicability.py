#!/usr/bin/env python3
"""
Test script to demonstrate gate applicability with frontend-only codebase
"""
...
def test_frontend_applicability():
    """Test function to run CodeGates validation with frontend-only codebase"""
    
    # Test parameters - using a frontend-only repository
    repository_url = "https://github.com/facebook/react"  # Frontend-only codebase
    branch = "main"
    github_token = None
    threshold = 70
